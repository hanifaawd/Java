...
public class posttest1Arraylist {
    ...
    // mencari mean
    public static double calculateMean(ArrayList<Integer> nilai, int numElement) {
        int total = 0;
        double average = 0.0;
    ...
    public static int findMax(ArrayList<Integer> nilai, int numElement) {
        int max = nilai.get(0);
        int idx = 0;
    ...
    public static int findMin(ArrayList<Integer> nilai, int numElement) {
        int min = nilai.get(0);
        int idx = 0;
    ...
    public static double calculateSD(ArrayList<Integer> nilai, int numElement) {
